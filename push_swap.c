...
/*   Updated: 2026/05/04 12:32:38 by varaniba      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_free_all(t_stack **stack_a, t_stack **stack_b, t_flags **flags, t_ops **counter)
{
...
int	main(int argc, char **argv)
{
	...
	return (ft_free_all(&stack_a, &stack_b, &flags, &counter), 0, 0);
}
