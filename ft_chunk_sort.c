...
static void	push_back_to_a(t_stack **stack_a, t_stack **stack_b, t_ops *counter)
{
	int	max_index;
...
void	ft_chunk_sort(t_stack **stack_a, t_stack **stack_b, t_ops *counter)
{
	int			chunk_amount;
	int			chunk_num;
	int			og_stack_size;
